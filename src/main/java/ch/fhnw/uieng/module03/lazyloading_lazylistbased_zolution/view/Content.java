...
import ch.fhnw.uieng.module03.lazyloading_lazylistbased_zolution.presentationmodel.CommunePM;
import ch.fhnw.uieng.module03.lazyloading_lazylistbased_zolution.view.util.FHNWTableView;
import ch.fhnw.uieng.module03.lazyloading_lazylistbased_zolution.view.util.LocalDateCell;
import ch.fhnw.uieng.module03.lazyloading_lazylistbased_zolution.view.util.ViewMixin;

/**
 * @author Dieter Holz
 */
class Content extends FHNWTableView<CommunePM> implements ViewMixin {
