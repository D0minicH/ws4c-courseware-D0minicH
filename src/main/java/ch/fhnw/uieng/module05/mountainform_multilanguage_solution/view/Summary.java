...
import ch.fhnw.uieng.module05.mountainform_multilanguage_solution.view.util.rectangularimageview.RectangularImageView;
...
class Summary extends GridPane implements ViewMixin {
    ...
    Summary(Switzerland switzerland) {
    ...
    public void setupValueChangedListeners() {
        switzerland.getCurrentMountain().cantonsProperty().addListener((observable, oldValue, newValue) -> {
    ...
    private ImageView createImageView(String canton, String cantonName) {
        ImageView imageView = new ImageView(new Image(
                Summary.class.getResourceAsStream("/wappen_klein/" + canton + ".png")));
