package ch.fhnw.uieng.module05.mountainform_attributebased_solution.view.util.rectangularimageview;
...
import ch.fhnw.uieng.module05.mountainform_attributebased_solution.view.util.ImageCache;
...
class RectangularImageViewSkin extends SkinBase<RectangularImageView> implements ImageCache {
    ...
    RectangularImageViewSkin(RectangularImageView control) {
        ...
        imageView.imageProperty().bind(Bindings.createObjectBinding(() -> getImage(getSkinnable().getImageURL()),
    ...
    protected void layoutChildren(double contentX, double contentY, double contentWidth, double contentHeight) {
        ...
        if (imageView.getImage() != null && currentImage.getWidth() > 0 && currentImage.getHeight() > 0 ) {
            Dimension2D bestFit = shouldFitIn(currentImage.getWidth(), currentImage.getHeight(), getWidthToFit(), getHeightToFit());
